...
public class CommandList {
  ...
  private Stack<Double> argumentStack, doubleParametersStack, listParametersStack;
  ...
  /**
   * The constructor for CommandList class, initializes the view, list of
   ...
   */
  public CommandList( String language) {
  ...
  private List<Command> parseText (Parser syntax, Parser lang, Parser params, List<String> lines) {
    ...
    return createdExtendedList(currentList);
  }
  ...
  private void doConstantWork(String line, List<Command> commandList){
    argumentStack.push(Double.parseDouble(line));
  ...
  private void pushParamsNeeded(String commandParams){
    ...
    if(doubleParamsString.equals(NO_MATCH)){
      ...
      doubleParametersStack.push(Double.parseDouble(doubleParamsString)); //add that value to the params stack
    }
  }
  ...
  private Command getCommand(String commandName){
    try{
      ...
      return makeCommand(commandParamsType(commandName), commandConstructor(commandClass));
  ...
  private Command makeCommand(String commandType, Constructor constructor) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    return (Command) constructor.newInstance(turtleListToGive, doubleListToGive(commandType), commandListToGive(commandType));
  }

  private List<Double> doubleListToGive(String commandType){
    //todo check for NO MATCH
    List<Double> doubles = new ArrayList<>();
    Integer doubleParamCount = Integer.parseInt(doubleParamsParser.getSymbol(commandType));
    //todo check if we already have this value... I think we do (but we pop it...)
  ...
  private List<Command> createdExtendedList(List<Command> l){
  ...
  /**
   * return the size of the CommandList created
   * @return
   */
  public int size(){
