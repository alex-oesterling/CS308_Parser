...
public class SetPosition extends Command {
  ...
  /**
   * Set position constructor, sets position of turtle without actually turning it, moves to that
   * position Calls super and sets the new position, with turtle facing same way
   *
